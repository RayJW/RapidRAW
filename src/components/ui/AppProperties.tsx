...
export const KEYBINDING_DEFINITIONS: KeybindingDefinition[] = [
  ...
  { actionKey: 'copy_adjustments', description: 'Copy selected adjustments', defaultCombo: ['ctrl', 'c'], section: 'general' },
  { actionKey: 'paste_adjustments', description: 'Paste copied adjustments', defaultCombo: ['ctrl', 'v'], section: 'general' },
  { actionKey: 'copy_files', description: 'Copy selected file(s)', defaultCombo: ['ctrl', 'shift', 'c'], section: 'general' },
  { actionKey: 'paste_files', description: 'Paste file(s) to current folder', defaultCombo: ['ctrl', 'shift', 'v'], section: 'general' },
  { actionKey: 'select_all', description: 'Select all images', defaultCombo: ['ctrl', 'a'], section: 'general' },
  ...
  { actionKey: 'zoom_out', description: 'Zoom out', defaultCombo: ['ctrl', '-'], section: 'editor' },
  ...
  { actionKey: 'rotate_right', description: 'Rotate 90° clockwise', defaultCombo: [']'], section: 'editor' },
  ...
  { actionKey: 'toggle_adjustments', description: 'Toggle Adjustments panel', defaultCombo: ['d'], section: 'editor' },
  ...
  { actionKey: 'toggle_analytics', description: 'Toggle Analytics display', defaultCombo: ['a'], section: 'editor' },
  { actionKey: 'toggle_export', description: 'Toggle Export panel', defaultCombo: ['e'], section: 'editor' },
  { actionKey: 'rate_0', description: 'Set star rating: 0', defaultCombo: ['0'], section: 'editor' },
  { actionKey: 'rate_1', description: 'Set star rating: 1', defaultCombo: ['1'], section: 'editor' },
  { actionKey: 'rate_2', description: 'Set star rating: 2', defaultCombo: ['2'], section: 'editor' },
  ...
  { actionKey: 'color_label_none', description: 'Clear color label', defaultCombo: ['shift', '0'], section: 'editor' },
  { actionKey: 'color_label_red', description: 'Set red color label', defaultCombo: ['shift', '1'], section: 'editor' },
  { actionKey: 'color_label_yellow', description: 'Set yellow color label', defaultCombo: ['shift', '2'], section: 'editor' },
  { actionKey: 'color_label_green', description: 'Set green color label', defaultCombo: ['shift', '3'], section: 'editor' },
  { actionKey: 'color_label_blue', description: 'Set blue color label', defaultCombo: ['shift', '4'], section: 'editor' },
  { actionKey: 'color_label_purple', description: 'Set purple color label', defaultCombo: ['shift', '5'], section: 'editor' },
