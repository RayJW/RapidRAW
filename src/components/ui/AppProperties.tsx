...
export const KEYBINDING_DEFINITIONS: KeybindingDefinition[] = [
  { actionKey: 'open_image', description: 'Open selected image', defaultCombo: ['Enter'], section: 'general' },
  { actionKey: 'copy_adjustments', description: 'Copy selected adjustments', defaultCombo: ['ctrl', 'KeyC'], section: 'general' },
  { actionKey: 'paste_adjustments', description: 'Paste copied adjustments', defaultCombo: ['ctrl', 'KeyV'], section: 'general' },
  { actionKey: 'copy_files', description: 'Copy selected file(s)', defaultCombo: ['ctrl', 'shift', 'KeyC'], section: 'general' },
  { actionKey: 'paste_files', description: 'Paste file(s) to current folder', defaultCombo: ['ctrl', 'shift', 'KeyV'], section: 'general' },
  { actionKey: 'select_all', description: 'Select all images', defaultCombo: ['ctrl', 'KeyA'], section: 'general' },
  { actionKey: 'delete_selected', description: 'Delete selected file(s)', defaultCombo: ['Delete'], section: 'general' },
  { actionKey: 'preview_prev', description: 'Previous image', defaultCombo: ['ArrowLeft'], section: 'editor' },
  { actionKey: 'preview_next', description: 'Next image', defaultCombo: ['ArrowRight'], section: 'editor' },
  { actionKey: 'zoom_in_step', description: 'Zoom in (by step)', defaultCombo: ['ArrowUp'], section: 'editor' },
  { actionKey: 'zoom_out_step', description: 'Zoom out (by step)', defaultCombo: ['ArrowDown'], section: 'editor' },
  { actionKey: 'cycle_zoom', description: 'Cycle zoom (Fit, 2x Fit, 100%)', defaultCombo: ['Space'], section: 'editor' },
  { actionKey: 'zoom_in', description: 'Zoom in', defaultCombo: ['ctrl', 'Equal'], section: 'editor' },
  { actionKey: 'zoom_out', description: 'Zoom out', defaultCombo: ['ctrl', 'Minus'], section: 'editor' },
  ...
  { actionKey: 'rotate_right', description: 'Rotate 90° clockwise', defaultCombo: ['BracketRight'], section: 'editor' },
  ...
  { actionKey: 'toggle_adjustments', description: 'Toggle Adjustments panel', defaultCombo: ['KeyD'], section: 'editor' },
  ...
  { actionKey: 'toggle_metadata', description: 'Toggle Metadata panel', defaultCombo: ['KeyI'], section: 'editor' },
  { actionKey: 'toggle_analytics', description: 'Toggle Analytics display', defaultCombo: ['KeyA'], section: 'editor' },
  { actionKey: 'toggle_export', description: 'Toggle Export panel', defaultCombo: ['KeyE'], section: 'editor' },
  { actionKey: 'rate_0', description: 'Set star rating: 0', defaultCombo: ['Digit0'], section: 'editor' },
  { actionKey: 'rate_1', description: 'Set star rating: 1', defaultCombo: ['Digit1'], section: 'editor' },
  { actionKey: 'rate_2', description: 'Set star rating: 2', defaultCombo: ['Digit2'], section: 'editor' },
  ...
  { actionKey: 'color_label_none', description: 'Clear color label', defaultCombo: ['shift', 'Digit0'], section: 'editor' },
  { actionKey: 'color_label_red', description: 'Set red color label', defaultCombo: ['shift', 'Digit1'], section: 'editor' },
  { actionKey: 'color_label_yellow', description: 'Set yellow color label', defaultCombo: ['shift', 'Digit2'], section: 'editor' },
  { actionKey: 'color_label_green', description: 'Set green color label', defaultCombo: ['shift', 'Digit3'], section: 'editor' },
  { actionKey: 'color_label_blue', description: 'Set blue color label', defaultCombo: ['shift', 'Digit4'], section: 'editor' },
  { actionKey: 'color_label_purple', description: 'Set purple color label', defaultCombo: ['shift', 'Digit5'], section: 'editor' },
  { actionKey: 'brush_size_up', description: 'Increase brush size', defaultCombo: ['ctrl', 'ArrowUp'], section: 'editor' },
  { actionKey: 'brush_size_down', description: 'Decrease brush size', defaultCombo: ['ctrl', 'ArrowDown'], section: 'editor' },
];
